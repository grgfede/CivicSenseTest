...
<head>
  ...
  <title>CivicSense - Statistiche</title>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        ...
        <div class="card-footer small text-muted">Aggiornato oggi alle 11:59</div>
      </div>
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="card mb-3">
            ...
            <div class="card-footer small text-muted">Aggiornato oggi alle 12:10 PM</div>
          </div>
        </div>
        <div class="col-lg-4">
          ...
          <div class="card mb-3">
            ...
            <div class="card-footer small text-muted">Aggiornato oggi alle 13.:06 PM</div>
          </div>
        </div>
      </div>
    </div>
