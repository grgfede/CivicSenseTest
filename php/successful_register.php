 ...
 <div class="row text-center">
	...
	<div class="col-sm-6 col-sm-offset-3">
		...
		<h3>Ciao, <?php echo $nome; ?></h3>
		  <p style="font-size:20px;color:#5C5C5C;">La registrazione &egrave; completata! Ti abbiamo inviato una email all'indirizzo <font color=green> <?php echo $mail; ?> </font> con le informazioni del tuo account.
